...
(function ($) {
  ...
  var barcode = {
    ...
    digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
      ...
      if (settings.showHRI){
        content += "<div style=\"clear:both; width: 90%;padding-left: 20px; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: left; font-size: " + settings.fontSize + "px; margin-top: " + settings.marginHRI + "px;\">"+hri+"</div>";
      }
